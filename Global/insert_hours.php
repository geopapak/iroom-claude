...
echo $editHTML;
$editHTML=<<<EOF
<form method="post" class="form" action="hours.php"  enctype="multipart/form-data">
                                <legend><h4>Δημιουργία ωραρίου</h4></legend>
                                <hr>
								<div>
                                    <label><strong>Αρχή:</strong></label>
									<select name="Start_hour" id="Select1" required>
										<option value="" disabled selected>-- Επιλογή Ώρας --</option>
								...
								<div>
                                    ...
                                    <select name="End_hour" id="Select2" required>
                                    	<option value="" disabled selected>-- Επιλογή Ώρας --</option>
										<option value="8">8.00</option>
										<option value="9">9.00</option>
										<option value="10">10.00</option>
								 ...
								 <div class="button">
										...
										<a href="database.php" class="btn btn-danger" >Πίσω</a>
                                </div>
                            </form>
 <footer>
 $footer
...
$(function(){
    $('#Select2').change(function(){
       ...
       var selectedMinValue = Number($('#Select1').val());
        
       if( selectedMaxValue > 0  && selectedMinValue > selectedMaxValue) {
           alert('Η ώρα αρχής δεν μπορεί να είναι μικρότερη από το τέλος.');
           ...
           alert('Επιλέξτε πρώτα την ώρα αρχής');
           $(this).find('option:first').attr('selected', 'selected'); //reset the second dropdown list
           $('#Select2').prop('selectedIndex',0);
       }       
